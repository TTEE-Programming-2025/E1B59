...
//這次完成座位預訂系統，讓我對 **C 語言** 的應用有更多了解，特別是在陣列處理和選單操作上有不少挑戰。
//剛開始寫程式時，因為功能需求較多，我常常不知道該從哪裡開始，寫出來的程式也經常有錯誤。
//特別是在處理錯誤輸入和清除畫面時，卡了很久才找到解決方法。雖然過程中不太順利，但透過一步步嘗試和修改，
//最終還是讓系統成功運作，讓我學到了如何解決程式設計中的困難。//
